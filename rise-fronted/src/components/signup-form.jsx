...
/**
 * SignupForm (presentational)
 * - UI-only form that mirrors the LoginForm styling.
 * - First name and Last name are placed side-by-side on md+ screens.
 * - No local state or validation (left to the consumer / server).
 */
